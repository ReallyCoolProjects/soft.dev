...
const initialState = {
  ...
  profileImage:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Jacques-Louis_David%2C_Le_Serment_des_Horaces.jpg/1280px-Jacques-Louis_David%2C_Le_Serment_des_Horaces.jpg",
  socials: ["Twitter", "Github", "LinkedIn"],
  role: ["software engineer"],
  skills: ["Javascript", "React", "Postgresql", "Express js"],
  name: "moussa",
  username: "moussa.tnm",
  bio: "Hello world",
  posts: [],
...
export const { changeRole, changeBio, changeName, changeSkills } = userSlice.actions
